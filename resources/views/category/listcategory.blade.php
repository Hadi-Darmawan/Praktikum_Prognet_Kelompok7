...
<div class="card">
    <div class="card-body text-center">
        ...
        <a href="{{ url('products/create') }}" class="btn btn-outline-secondary btn-lg btn-block">Add Product</a>
    </div>
</div>
...
<div class="card p-3 mb-5 pb-3 mt-4">
    ...
    <ul class="list-group py-4 px-4">
        ...
        <li class="list-group-item d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('categories.edit',$category->id) }}" class="badge badge-info px-2 py-2">Detail</a>
        </li>
        @endforeach
    </ul>
    <div class="form-group mb-3 px-4">
        <form class="input-group mb-3" method="post" action="{{ route('categories.store') }}">
        @csrf
