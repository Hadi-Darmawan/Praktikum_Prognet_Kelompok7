            ...
            <main role="main" class="inner cover text-left">
                <div class="card text-white bg-dark mb-3" style="max-width: 600px;">
                    <div class="row no-gutters">
                        <div class="col-md-4">
                            <img src="/uploads/avatars/{{ $user->profile_image }}" alt="..." class="rounded border border-secondary img-fluid" style="width: 100%; height: 100%;">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                            ...
                            <div class="card-body">
                                <a class="text-secondary text-decoration-none" href="/user/logout" class="text-white">logout</a>
                            </div>
                        </div>
                    </div>
                </div>
