	...
	<div class="cart_info ganti">
		<div class="container">
			...
			@forelse ($cart as $isi)
						...
						<div class="cart_item d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-start">
							<div class="cart_item_product d-flex flex-row align-items-center justify-content-start">
								...
								<div class="cart_item_name_container">
									<div class="cart_item_name">
										<a href="#">{{$isi->product->product_name}}</a>
									</div>
								</div>
							</div>
							@php
							...
							<div class="cart_item_quantity">
								...
								<div class="btn-group radio-group ml-2" data-toggle="buttons">
									...
									<label class="btn btn-sm btn-danger btn-rounded tombolhapus" >
				...
				@empty
					<p class="fa fa-shopping-cart" style="font-size:50px;margin-left:495px;" align="center">
						<br>
						<br>
						Cart Kosong!
					</p>
					...
					<div class="cart_total text-center">
						...
						<div align="center">
							...
							@csrf
								...
								<button type="submit" class="btn btn-dark">Buy Item</button>
							</form>
						</div>
					</div>
				</div>
