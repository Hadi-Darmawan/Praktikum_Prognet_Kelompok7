...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
            <div class="text-center mb-4 m-auto">
                ...
                <p>Start your online Shopping. You have any account? Please <a href="{{ url('/login') }}">Login Here</a></p>
            </div>
        <form class="form-signin" method="POST" action="{{ route('register') }}">
        @csrf

            <div class="form-label-group">
                <input type="text" name="name" id="inputName" class="form-control @error('name') is-invalid @enderror" placeholder="Full name" value="{{ old('Nama') }}" autofocus autocomplete="off">
            ...
            <div class="form-label-group">
                <input type="password" name="password-confirmation" id="inputPassword" class="form-control @error('password_confirmation') is-invalid @enderror" placeholder="Password Confirmation">
